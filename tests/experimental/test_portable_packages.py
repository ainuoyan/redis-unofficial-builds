...
class PortablePackageTests(unittest.TestCase):
    ...
    def test_portable_build_stabilizes_tests_and_uses_a_short_macos_temp_root(self) -> None:
        ...
        self.assertIn(
            Path("packaging/linux/patches/redis-8.4.7-test-stability.patch"),
            portable_contract.patchset_paths("macos15"),
        )
        self.assertIn(
        ...
        self.assertIn(
            Path("packaging/linux/patches/redis-8.6.7-test-stability.patch"),
            portable_contract.patchset_paths("macos15"),
        )
        self.assertIn(
        ...
        self.assertIn(
            Path("packaging/linux/patches/redis-8.8.3-test-stability.patch"),
            portable_contract.patchset_paths("macos15"),
        )
        self.assertNotIn(
            Path("packaging/linux/patches/apply_upstream_test_fixes.py"),
